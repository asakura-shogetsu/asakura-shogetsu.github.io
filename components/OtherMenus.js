  ...
  return (
    <div className="mx-6 my-4">
      <div className='flex gap-1 justify-center flex-wrap'>
        <MenuImage pic="img/menu/menu2023_1_2.webp" alt="松月メニュー1" />
        <MenuImage pic="img/menu/menu2023_1_3.webp" alt="松月メニュー2" />
        <MenuImage pic="img/menu/menu2023_1_4.webp" alt="松月メニュー3" />
        <MenuImage pic="img/menu/menu2023_1_5.webp" alt="松月メニュー4" />
        ...
        <MenuImage pic="img/menu/menu2023_2_4.webp" alt="松月メニュー8" />
